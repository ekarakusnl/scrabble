...
--
-- Name: roles; Type: TABLE; Schema: public; Owner: scrabble_api
--
...
ALTER TABLE public.roles OWNER TO scrabble_api;

--
-- Name: roles_id_seq; Type: SEQUENCE; Schema: public; Owner: scrabble_api
--
...
--
-- Name: roles roles_pkey; Type: CONSTRAINT; Schema: public; Owner: scrabble_api
--
...
--
-- Name: roles uk_role_type; Type: CONSTRAINT; Schema: public; Owner: scrabble_api
--
...
ALTER TABLE ONLY public.user_roles
    ADD CONSTRAINT uk_user_role UNIQUE (username, type, enabled);
