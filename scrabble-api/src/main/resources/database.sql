...
--
-- Data for Name: actions; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.actions (id, created_date, last_updated_date, counter, current_player_number, game_id, game_status, round_number, type, user_id) FROM stdin;
\.


--
-- Data for Name: bags; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.bags (id, created_date, last_updated_date, enabled, language, name, tile_count) FROM stdin;
\.


--
-- Data for Name: boards; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.boards (id, created_date, last_updated_date, column_size, enabled, name, row_size) FROM stdin;
\.


--
-- Data for Name: cells; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.cells (id, created_date, last_updated_date, board_id, cell_number, center, color, column_number, has_bottom, has_left, has_right, has_top, letter_value_multiplier, row_number, word_score_multiplier) FROM stdin;
\.


--
-- Data for Name: chats; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.chats (id, created_date, last_updated_date, game_id, message, user_id) FROM stdin;
\.


--
-- Data for Name: games; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.games (id, created_date, last_updated_date, action_counter, active_player_count, bag_id, board_id, current_player_number, duration, end_date, expected_player_count, name, owner_id, round_number, start_date, status) FROM stdin;
\.


--
-- Data for Name: players; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.players (id, created_date, last_updated_date, game_id, joined_date, left_date, player_number, score, user_id) FROM stdin;
\.


--
-- Data for Name: tiles; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.tiles (id, created_date, last_updated_date, bag_id, count, letter, value, vowel) FROM stdin;
\.


--
-- Data for Name: user_roles; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.user_roles (id, created_date, last_updated_date, enabled, role, user_id) FROM stdin;
\.


--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.users (id, created_date, last_updated_date, account_non_expired, account_non_locked, credentials_non_expired, email, enabled, password, username) FROM stdin;
\.


--
-- Data for Name: words; Type: TABLE DATA; Schema: public; Owner: scrabble_api
--

COPY public.words (id, created_date, last_updated_date, game_id, round_number, score, user_id, word) FROM stdin;
\.
